---
title: packmanlib::node::UPfile

---

# packmanlib::node::UPfile
...
|                | Name           |
| -------------- | -------------- |
| def | **[__init__](classpackmanlib_1_1node_1_1_u_pfile.md#function---init--)**(self self, [platform](classpackmanlib_1_1node_1_1_archive.md#variable-platform) platform) |
| def | **[uptype](classpackmanlib_1_1node_1_1_u_pfile.md#function-uptype)**(self self) |
| def | **[ending](classpackmanlib_1_1node_1_1_u_pfile.md#function-ending)**(self self) |
| def | **[create_upfile](classpackmanlib_1_1node_1_1_u_pfile.md#function-create-upfile)**([platform](classpackmanlib_1_1node_1_1_archive.md#variable-platform) platform, [name](classpackmanlib_1_1nodeaction_1_1_node_action_mixin.md#variable-name) name, [uptype](classpackmanlib_1_1node_1_1_u_pfile.md#function-uptype) uptype)<br>Create a upfile node Name of node will be '[name].  |
| def | **[build_ending](classpackmanlib_1_1node_1_1_u_pfile.md#function-build-ending)**([uptype](classpackmanlib_1_1node_1_1_u_pfile.md#function-uptype) uptype) |
...
### function create_upfile

```python
static def create_upfile(
    platform platform,
    name name,
    uptype uptype
)
...
**Parameters**: 
  ...
  * **name** name to be used for the archive 
  * **uptype** upfile type 
...
### function build_ending

```python
static def build_ending(
    uptype uptype
)
```
