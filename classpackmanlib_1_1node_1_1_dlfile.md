---
title: packmanlib::node::Dlfile

---

# packmanlib::node::Dlfile
...
|                | Name           |
| -------------- | -------------- |
| def | **[__init__](classpackmanlib_1_1node_1_1_dlfile.md#function---init--)**(self self, [platform](classpackmanlib_1_1node_1_1_archive.md#variable-platform) platform) |
| def | **[new_archive_child](classpackmanlib_1_1node_1_1_dlfile.md#function-new-archive-child)**(self self) |
| def | **[is_differential](classpackmanlib_1_1node_1_1_dlfile.md#function-is-differential)**(self self) |
| def | **[create_dlfile](classpackmanlib_1_1node_1_1_dlfile.md#function-create-dlfile)**([platform](classpackmanlib_1_1node_1_1_archive.md#variable-platform) platform, base_name base_name, stem_name stem_name =None)<br>Create a dlfile node Name of node will be '[stem_name].tgz'.  |
...
### function create_dlfile

```python
static def create_dlfile(
    platform platform,
    base_name base_name,
...
**Parameters**: 
  ...
  * **stem_name** will be 'dl.[base_name]' if not provided 
