---
title: packmanlib::node::DlfileMeta

---

# packmanlib::node::DlfileMeta
...
|                | Name           |
| -------------- | -------------- |
| def | **[__init__](classpackmanlib_1_1node_1_1_dlfile_meta.md#function---init--)**(self self, [platform](classpackmanlib_1_1node_1_1_archive.md#variable-platform) platform) |
| def | **[create](classpackmanlib_1_1node_1_1_dlfile_meta.md#function-create)**([platform](classpackmanlib_1_1node_1_1_archive.md#variable-platform) platform) |
...
```python
class packmanlib::node::DlfileMeta;
```
